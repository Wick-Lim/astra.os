...
fn test_phase1_features() {
    ...
    // Test 2: HTML Rendering (now using Servo's html5ever)
    serial_println!("[TEST 2] HTML Rendering");
    serial_println!("  HTML rendering will use Servo's html5ever");
    serial_println!("  Skipping old HTML renderer test");
